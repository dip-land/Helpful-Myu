...
import { client, mongoClient } from '../../index.js';
import importData from './import.js';
import { readdir } from 'fs/promises';
import path from 'path';

await mongoClient.connect();
const database = mongoClient.db(client.beta ? 'MB' : client.version.toUpperCase());
